...
%%  PMU voltage data (confidence intervals around measurements)
%	bus_i	VR_MAX	VR_MIN	VI_MAX	VI_MIN
mpc.Vpmu = [
	2	1.04785	1.04785	-0.0672314	-0.0672314;
	4	0.987459	0.986054	-0.0723431	-0.0724393;
];

%% PMU current injection data (confidence intervals around measurements)
%	bus_i	IR_MAX	IR_MIN	II_MAX	II_MIN
mpc.Ipmu = [
	2	0.42987	0.42987	-0.737194	-0.737194;
	4	-0.653408	-0.65437	0.757911	0.7568;
];

%% RTU injection data (confidence intervals around measurements)
%	bus_i	P_MIN	P_MAX	Q_MIN	Q_MAX	V_MIN	V_MAX
mpc.RTU = [
	1	   1.0453	1.1205856	 0.153775	0.165740889	1.04598054	1.05371603;
	3	 0.580249	0.619849015	 0.867184	0.928140571	1.06645655	1.07335566;
	5	-0.721302	-0.677961721	-0.725495	-0.677329608	0.981667732	0.989350818;
	6	-0.726976	-0.675635918	-0.727482	-0.678734022	1.0008372	1.00822787;
];
